...
// ===== 常量 =====
let VEIN_4 = "gensokyo_mechanician:iron_vein_block"
let VEIN_ACTIVE_4 = "gensokyo_mechanician:active_iron_vein_block"
let FLUID = "minecraft:lava";
let FLUID_2 = "gensokyo_mechanician:mineral_enrichment_fluid";
let ORE_4 = "minecraft:iron_ore";
...
BlockEvents.rightClicked(VEIN_4, (event) => {
  event.server.tell("§e所有玩家注意：KubeJS 脚本已加载");
    ...
    event.server.runCommandSilent(`setblock ${event.block.x} ${event.block.y} ${event.block.z} ${VEIN_ACTIVE_4}`)
