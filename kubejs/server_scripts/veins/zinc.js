...
// ===== 常量 =====
let VEIN_3 = "gensokyo_mechanician:zinc_vein_block"
let VEIN_ACTIVE_3 = "gensokyo_mechanician:active_zinc_vein_block"
let FLUID = "minecraft:lava";
let FLUID_2 = "gensokyo_mechanician:mineral_enrichment_fluid";
let ORE_3 = "create:zinc_ore";
...
BlockEvents.rightClicked(VEIN_3, (event) => {
  event.server.tell("§e所有玩家注意：KubeJS 脚本已加载");
    ...
    event.server.runCommandSilent(`setblock ${event.block.x} ${event.block.y} ${event.block.z} ${VEIN_ACTIVE_3}`)
