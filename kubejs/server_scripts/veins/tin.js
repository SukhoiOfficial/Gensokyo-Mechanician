...
// ===== 常量 =====
let VEIN_2 = "gensokyo_mechanician:tin_vein_block"
let VEIN_ACTIVE_2 = "gensokyo_mechanician:active_tin_vein_block"
let FLUID = "minecraft:lava";
let FLUID_2 = "gensokyo_mechanician:mineral_enrichment_fluid";
let ORE_2 = "create_ironworks:tin_ore";
...
BlockEvents.rightClicked(VEIN_2, (event) => {
  event.server.tell("§e所有玩家注意：KubeJS 脚本已加载");
    ...
    event.server.runCommandSilent(`setblock ${event.block.x} ${event.block.y} ${event.block.z} ${VEIN_ACTIVE_2}`)
